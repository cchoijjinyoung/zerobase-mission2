...
import com.zerobase.mission2.repository.TransactionRepository;
...
import static com.zerobase.mission2.type.TransactionResultType.F;
import static com.zerobase.mission2.type.TransactionResultType.S;
import static com.zerobase.mission2.type.TransactionType.*;
...
class TransactionServiceTest {
    ...
    void cancleTransaction_AccountNotFound() {
        // given
        given(transactionRepository.findByTransactionId(anyString()))
    ...
    void cancleTransaction_TransactionNotFound() {
        // given
        given(transactionRepository.findByTransactionId(anyString()))
                .willReturn(Optional.empty());
        // when
    ...
    void cancleTransaction_CancelMustFully() {
        // given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    @Test
    @DisplayName("일년이 지난 거래는 취소 불가 - 잔액 사용 취소 실패")
    void cancleTransaction_TooOldOrderToCancel() {
        // given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
